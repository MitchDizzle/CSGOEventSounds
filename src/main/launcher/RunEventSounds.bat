...
"%JAVA_HOME%\bin\java.exe" -classpath %classpath% wtf.dizzle.csgostate.eventsounds.EventSounds SoundConfig.cfg
goto End

:Run
echo Launching EventSounds
java.exe -classpath %classpath% wtf.dizzle.csgostate.eventsounds.EventSounds SoundConfig.cfg
goto End
